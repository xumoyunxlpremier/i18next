...
import customizeIcon from "../assets/customize.svg";
 ...
 function AdvancedStats() {
  ...
  const icons = [brandIcon, recordsIcon, customizeIcon];
    ...
    <section id="features" className="bg-[#f0f1f6] py-24">
      <div className="max-w-[1140px] mx-auto px-6 text-center">
        ...
        <div className="relative flex flex-col md:flex-row md:gap-8 gap-16 justify-center items-start">
          <div className="absolute md:top-[120px] left-1/2 md:left-0 md:right-0 w-2 md:w-[80%] mx-auto h-full md:h-2 bg-cyan-400 md:bg-cyan-400 md:translate-x-0 -translate-x-1/2 md:translate-y-0 translate-y-24 md:mx-0 rounded-full"></div>
          ...
          {loading
            ...
            : data.map((card, index) => (
                <div
                  key={index}
                  className={`relative bg-white p-10 rounded-xl shadow-md text-left w-full md:w-1/3 z-10 ${
